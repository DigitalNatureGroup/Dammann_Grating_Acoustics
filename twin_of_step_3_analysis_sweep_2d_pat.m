...
for ii = 1:length(best_comb_trap)
    ...
    set(gca,'FontSize',24)
    axis equal
    exportgraphics(gca, ['selected_twin\selected_trap_n_' num2str(unique_trap_n(ii)) 'pat.png'])
    ...
    exportgraphics(gca, ['selected_twin\selected_trap_n_' num2str(unique_trap_n(ii)) 'pat_phase.png'])
