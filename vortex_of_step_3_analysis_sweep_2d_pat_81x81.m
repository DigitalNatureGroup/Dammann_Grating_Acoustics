...
for ii = 1:length(best_comb_trap)
    ...
    set(gca,'FontSize',24)
    axis equal
    exportgraphics(gca, ['81x81_selected_vortex\selected_trap_n_' num2str(unique_trap_n(ii)) 'pat.png'])
    ...
    exportgraphics(gca, ['81x81_selected_vortex\selected_trap_n_' num2str(unique_trap_n(ii)) 'pat_phase.png'])
