function [damman_mask, combined_2d] = generate_damman_rotate(damman_x, damman_x_k,damman_y, damman_y_k, transducer_x, transducer_y, angle_rotate)
...
J = imrotate(combined_2d, angle_rotate,"nearest","crop");
...
for tr = 1:length(transducer_x)
    damman_mask(tr) = sign(interpn(x, y, J, transducer_x(tr), transducer_y(tr)));
end
