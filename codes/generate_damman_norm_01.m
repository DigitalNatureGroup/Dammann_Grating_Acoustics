function [damman_mask, combined_2d] = generate_damman_norm_01(damman_x, damman_x_k,damman_y, damman_y_k, transducer_x, transducer_y)
...
transducer_x = (transducer_x ./ 0.1).*0.49;
transducer_y = (transducer_y ./ 0.1).*0.49;
